 ...
 * ----------------------------------------------------------------------------------------
 * Usage:
 * new JsModal([Object object] options);
 * options:
...
(function(name, definition) {
    ...
    JsModal.prototype.initDragObject = function () {
        var _this = this;
    ...
    JsModal.prototype.startDrag = function () {
        var _this = this;
    ...
    JsModal.prototype.calculateBorders = function (target, e) {
        e = window.event || e;
    ...
    JsModal.prototype.initCloseEvent = function () {
        var _this = this;
    ...
    JsModal.prototype.createBox = function () {
    ...
    JsModal.prototype.setContent = function(opts) {
    ...
    JsModal.prototype.setCenter = function() {
        var blockBody = this.utils.getElementByClass('message-block');
    ...
    JsModal.prototype.initGallery = function(containerId) {
